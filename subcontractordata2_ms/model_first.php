...
switch($ch) {
	case 'edit':
		$title = "編輯作業";
		$sid = "view01";
		$modal = $m_location."/sub_modal/project/func02/subcontractordata2_ms/subcontractordata2_modify.php";
		include $modal;
	...
	default:
		if (empty($sid))
			$sid = "mbpjitem";
		$modal = $m_location."/sub_modal/project/func02/subcontractordata2_ms/subcontractordata2.php";
		include $modal;
		$smarty->assign('xajax_javascript', $xajax->getJavascript('/xajax/'));
		break;
};
